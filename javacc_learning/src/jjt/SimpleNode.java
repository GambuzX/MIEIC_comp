...
class SimpleNode implements Node {
  ...
  public void dump(String prefix) {
    ...
    if (children == null)
      System.out.println("\t[ " + (this.id == CalculatorTreeConstants.JJTRETRIEVE ? this.label : this.val) + " ]");
...
/* JavaCC - OriginalChecksum=7b4f2c953ae7300dd8ef51a97128ffd1 (do not edit this line) */
